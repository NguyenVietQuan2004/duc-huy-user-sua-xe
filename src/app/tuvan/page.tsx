      ...
      <div className="max-w-[1100px] px-4  mx-auto  pt-40 text-[18px] py-20 flex flex-col gap-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {currentItems.map((promo) => {
            ...
            return (
              <Link href={""} key={promo.id} className="border rounded-sm p-4 flex flex-col shadow-md">
                ...
                <div className="flex gap-4 mb-1 items-start">
                  ...
                  <div className="text-sm text-gray-700 leading-snug  line-clamp-4">{promo.sub}</div>
                </div>
